...
function HomeScreens({navigation, route}) {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, contentStyle: {backgroundColor: '#121212'}, navigationBarColor: "#121212"}} >
  ...
  return (
    <Tab.Navigator
      ...
      screenOptions={{
        ...
        tabBarStyle: { backgroundColor: '#121212', borderTopWidth: 0, elevation: 0 },
      }}
    >
      <Tab.Screen
        name="HomeScreens"
